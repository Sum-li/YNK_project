// page/common/components/picker/picker.js
Component({
  /**
   * 组件的属性列表
   */
  ...
  data: {
    ...
    rowLise: {
      row_weiyang: {
        id: 0,
        name: ['未央1路', '未央2路', '未央3路', '未央4路', '未央5路', '未央6路', '未央7路', '未央8路']
      },
      row_beilin: {
        id: 1,
        name: ['碑林1路', '碑林2路', '碑林3路', '碑林4路', '碑林5路', '碑林6路', '碑林7路', '碑林8路']
      },
      row_xincheng: {
        id: 2,
        name: ['新城1路', '新城2路', '新城3路', '新城4路', '新城5路', '新城6路', '新城7路', '新城8路']
      },
      row_yanta: {
        id: 3,
        name: ['雁塔1路', '雁塔2路', '雁塔3路', '雁塔4路', '雁塔5路', '雁塔6路', '雁塔7路', '雁塔8路']
      },
      row_gaoxin: {
        id: 4,
        name: ['高新1路', '高新2路', '高新3路', '高新4路', '高新5路', '高新6路', '高新7路', '高新8路']
      },
      row_baqiao: {
        id: 5,
        name: ['灞桥1路', '灞桥2路', '灞桥3路', '灞桥4路', '灞桥5路', '灞桥6路', '灞桥7路', '灞桥8路']
      },
      row_changan: {
        id: 5,
        name: ['长安1路', '长安2路', '长安3路', '长安4路', '长安5路', '长安6路', '长安7路', '长安8路']
      }
    },
